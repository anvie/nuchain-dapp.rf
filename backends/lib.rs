...
mod $name_snake_case$ {
    ...
    mod tests {
        ...
        fn register_works() {
            ...
            let rv = contract.register("USER1".to_string());
            assert!(rv.is_some());
            let (hash, id) = rv.unwrap();
